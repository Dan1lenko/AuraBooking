      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between bg-white border border-slate-200 p-4 md:px-6 md:py-3 rounded-xl shadow-sm gap-4">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-3.5 py-1.5 border border-slate-200 rounded-lg hover:bg-slate-50 text-slate-600 text-xs font-semibold transition-colors cursor-pointer w-full md:w-auto"
          >
